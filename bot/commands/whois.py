...
def _build_whois_embed(user: discord.Member, invite_info: dict | None) -> discord.Embed:
    guild = user.guild
...
async def _run_whois(interaction: discord.Interaction, user: discord.Member) -> None:
    ...
    embed = _build_whois_embed(user, invite_info)
...
def setup(bot):
    ...
    async def whois(interaction: discord.Interaction, user: discord.Member):
        await _run_whois(interaction, user)

    @bot.tree.context_menu(name="Whois")
    async def whois_context(interaction: discord.Interaction, user: discord.Member):
        await _run_whois(interaction, user)
